...
* Extract Organisation chart 
	...
	* Functional Organisation 
		...
		* Advantages 
			...
			* operational with homogenous product portfolio 以同质化产品组合展开服务 
		* Disadvantages 
	...
	* Holding Organisation 
		...
		* Types 
			...
			* Management Holding 
				* small parent company with management tasks, big subsidiaries 
			* Financial Holding 
				* Small parent company with purely administrative tasks 
		* Advantages 
			* high autonomy in each subsidiary 
		* Disadvantages 
	...
	* Matrix-Organisation 
		...
		* Advantages 
			...
			* higher productivity, better decisions 
		* Disadvantages 
			* Difficult demarcation 划分界限 of competences 权限 between superiors 高层 
